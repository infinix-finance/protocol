...
export type AmmAddedEvent = TypedEvent<[string] & { amm: string }>;

export type AmmRemovedEvent = TypedEvent<[string] & { amm: string }>;

export type OwnershipTransferredEvent = TypedEvent<
  [string, string] & { previousOwner: string; newOwner: string }
>;

export type ShutdownAllAmmsEvent = TypedEvent<
  [BigNumber] & { blockNumber: BigNumber }
>;

export type TokenAddedEvent = TypedEvent<[string] & { tokenAddress: string }>;

export type TokenRemovedEvent = TypedEvent<[string] & { tokenAddress: string }>;

export type WithdrawnEvent = TypedEvent<
  [string, BigNumber] & { withdrawer: string; amount: BigNumber }
>;
...
export class InsuranceFund extends BaseContract {
  ...
  filters: {
    "AmmAdded(address)"(
      amm?: null
    ): TypedEventFilter<[string], { amm: string }>;
