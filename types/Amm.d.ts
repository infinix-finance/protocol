...
interface AmmInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setSpreadRatio((uint256))": FunctionFragment;
    "setTollRatio((uint256))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "MAX_ORACLE_SPREAD_RATIO",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type FundingRateUpdatedEvent = TypedEvent<
  [BigNumber, BigNumber] & { rate: BigNumber; underlyingPrice: BigNumber }
>;
...
export class Amm extends BaseContract {
  ...
  filters: {
    ...
    "FundingRateUpdated(int256,uint256)"(
      rate?: null,
      underlyingPrice?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
      { rate: BigNumber; underlyingPrice: BigNumber }
    >;
    ...
    "LiquidityChanged(uint256,uint256,int256)"(
      quoteReserve?: null,
      baseReserve?: null,
